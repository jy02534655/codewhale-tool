...
export const SERVER_MSG = {
  ...
  'en': {
    ...
    INVALID_BASE_URL: 'Invalid Base URL format, please enter a valid http/https URL',
  ...
  'ja': {
    ...
    INVALID_BASE_URL: 'Base URL の形式が正しくありません。有効な http/https URL を入力してください',
  ...
  'pt-BR': {
    ...
    INVALID_BASE_URL: 'Formato de Base URL inválido, insira uma URL http/https válida',
