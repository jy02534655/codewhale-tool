  ...
  <el-card class="settings-card" shadow="never">
    ...
    <div class="settings-grid">
      <el-form-item :label="$t('settings.notifications_method')" prop="notifications_method">
        <template #label>
          <div class="form-item-label">
            <span>{{ $t('settings.notifications_method') }}</span>
            <el-tooltip placement="top" :content="helpText.notifications_method">
      ...
      <el-form-item :label="$t('settings.notifications_threshold_secs')" prop="notifications_threshold_secs">
        <template #label>
          <div class="form-item-label">
            <span>{{ $t('settings.notifications_threshold_secs') }}</span>
            <el-tooltip placement="top" :content="helpText.notifications_threshold_secs">
              <el-icon class="help-icon"><QuestionFilled /></el-icon>
            </el-tooltip>
          </div>
        </template>
      ...
      <el-form-item :label="$t('settings.notifications_completion_sound')" prop="notifications_completion_sound">
        <template #label>
          <div class="form-item-label">
            <span>{{ $t('settings.notifications_completion_sound') }}</span>
            <el-tooltip placement="top" :content="helpText.notifications_completion_sound">
              <el-icon class="help-icon"><QuestionFilled /></el-icon>
            </el-tooltip>
          </div>
        </template>
...
const helpText = {
  notifications_method: settingsHelp.notifications_method,
  notifications_threshold_secs: settingsHelp.notifications_threshold_secs,
  notifications_completion_sound: settingsHelp.notifications_completion_sound,
};
</script>